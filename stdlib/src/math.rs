...
impl MathModule {
    ...
    /// Absolute value
    fn abs(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Square root
    fn sqrt(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Sine function
    fn sin(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Cosine function
    fn cos(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Tangent function
    fn tan(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Arcsine function
    fn asin(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Arccosine function
    fn acos(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Arctangent function
    fn atan(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    fn atan2(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 2 {
    ...
    /// Natural logarithm
    fn log(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Base-10 logarithm
    fn log10(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Base-2 logarithm
    fn log2(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    fn exp(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Power function (x^y)
    fn pow(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 2 {
    ...
    /// Floor function
    fn floor(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Ceiling function
    fn ceil(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Round function
    fn round(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 1 {
    ...
    /// Minimum function
    fn min(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 2 {
    ...
    /// Maximum function
    fn max(args: &[Val], _env: &lkr_core::stmt::Environment) -> Result<Val> {
        if args.len() != 2 {
